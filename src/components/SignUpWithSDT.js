...
const SignUpWithSDT=()=>{
    ...
    <Form className="col-11 col-lg-4 col-md-4 mx-auto ">
      ...
      <Form.Group className="mb-3" controlId="formBasicEmail">
        ...
        <Row>
            <h7 className="text-secondary mb-4">Ngày sinh của bạn sẽ không được hiển thị công khai.</h7>
        </Row>
        <Row>
        <Col><Form.Label>Điện thoại</Form.Label></Col>
        <Col className="text-end"><Form.Label className="fss"><NavLink to="/SignUpWithEmail"className=" link-dark text-danger decorate fw-semibold ">Đăng ký bằng email </NavLink></Form.Label></Col>
        </Row>
