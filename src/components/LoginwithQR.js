      ...
      <>
        ...
        <Container className="mt-5 mx-auto  ">
          ...
          <Container>
            <Row>
              <Col className="user-select-none"></Col>
              <Col className="col-10 col-lg-4 col-md-4 ">
                <h1 className="text-center text-break fw-bold boxQR rounded-3 py-auto shadow">
            ...
            <Row>
              ...
              <Col className="col-12">
                <h6 className="text-center text-break  ">
                  1. Scan with your mobile device’s camera <br />
