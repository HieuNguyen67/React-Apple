...
const responseFacebook = (response) => {
    ...
    <Form className="col-10 col-lg-4 col-md-4 mx-auto ">
      <Form.Group className="mb-3" controlId="formBasicEmail">
        ...
        <Col className="text-end"><Form.Label className="fss"><NavLink to="/5" className=" link-dark text-danger decorate fw-semibold">Đăng nhập bằng SĐT </NavLink></Form.Label></Col>
        </Row>
      ...
      <Form.Group className="mb-3 " controlId="formBasicPassword">
        ...
        <Col>Password</Col>
        <Col className="text-end"><NavLink className=" link-dark text-primary decorate ">Forgot password?</NavLink></Col>
        </Row> 
